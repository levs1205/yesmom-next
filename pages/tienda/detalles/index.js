                            ...
                            <div className="show--contenedor-centered">
                                <div className="show--all-content">
                                    <div className="show--title-content hide-desktop">
                                        <h4 className="title-breadcrumb">Inicio / Tienda / Solo en Yes Mom / Ropa </h4>
                                    </div>
                                                ...
                                                <section className="show--some-info-product">
                                                    ...
                                                    <div className="show--container-selects"> 
                                                        <div className="show--group-select">
                                                            ...
                                                            <select id="color">
                                                                <option selected disabled>Selecciona el color</option>
                                        ...
                                        <div className="show--container-details">
                                            <section className="show--all-info-producto">
                                                ...
                                                <p className="show--text-description">
                                                    ...
                                                    Ac ipsum fames gravida habitant aliquet orci. 
                                                    Imperdiet egestas morbi egestas posuere diam. 
                                                    Pharetra, sit volutpat varius sed sit urna euismod. 
                                                    Viverra nunc turpis nulla at et venenatis vitae, facilisis fringilla. 
                                            ...
                                            <section className="show--other-products">
                                                <div className="box-title-otros-productos">
                                                    ...
                                                    <div className="title-fuxia">Otros productos<br className="hide-desktop"/> que te pueden interesar</div>
                                                    <div className="icon-title-video">
                                                        <FontAwesomeIcon
                                                        icon={faStar}
                                                        className="cl-yellow heartbeat"
