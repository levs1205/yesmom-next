          ...
          <div className="checkout-block__card">
            ...
            <form action="" className="identification-form">
              <div className="identification-form__wrapper">
                <label for="email" className="identification-form__label">
              ...
              <div className="identification-form__wrapper">
                <label for="name" className="identification-form__label">
                  Nombre y Apellido:
                </label>
                <input
                  type="text"
              ...
              <div className="identification-form__wrapper">
                <label for="identity" className="identification-form__label">
              ...
              <div className="identification-form__wrapper">
                <label for="phone" className="identification-form__label">
                  Teléfono / Móvil:
                </label>
                <input
                  type="text"
              ...
              <div className="only-button-submit">
                <div className="btn-checkout btn-yellow">Continuar</div>
              </div>
            </form>
            {/* <div className="checkout-block__text">
              <p className="checkout-block__text--font-size-and-bold">
