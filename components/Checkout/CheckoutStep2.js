    ...
    <>
      ...
      <div className="checkout-location-form__wrapper">
        ...
        <div className="checkout-location-form__box-radio">
          <div className="checkout-location-from__wrapper-radio">
            <input
          ...
          <div className="checkout-location-form__wrapper-radio">
            <input
              className="checkout-location-form__input-radio"
              type="radio"
              id="f-option2"
      ...
      </div>
      {
        recibePedido==='1' &&  
        <div className="checkout-location-form__wrapper">
          <label htmlFor="nameRecibeTercero" className="checkout-location-form__label">
            Nombre y Apellidos
          </label>
          <input
            type="text"
            className="checkout-location-form__input"
            name="nameRecibeTercero"
            id="nameRecibeTercero"
